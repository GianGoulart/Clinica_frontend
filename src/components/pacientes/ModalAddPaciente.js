...
const ModalAddPaciente = ({ classes, open, onClose, edit, pacienteProps }) => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            setLoading(true)
                const response = await PacienteService.savePaciente(paciente)
                dispatch({
                    type: 'SET_SNACKBAR',
                    payload: {
    ...
    return (
        <Dialog
            ...
            fullWidth
        >   
            <DialogTitle className={classes.dialogTitle}>Cadastrar Paciente</DialogTitle>                
...
export default withStyles(ModalAddPacienteStyle)(ModalAddPaciente);